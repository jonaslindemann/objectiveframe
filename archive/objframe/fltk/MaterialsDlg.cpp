...
void MaterialsDlg::cb_lbMaterials_i(Fl_Browser*, void*) {
  if (m_materials!=NULL)
{
...
void MaterialsDlg::cb_lbMaterials(Fl_Browser* o, void* v) {
  ((MaterialsDlg*)(o->parent()->user_data()))->cb_lbMaterials_i(o,v);
}

void MaterialsDlg::cb_btnAddMaterial_i(Fl_HoverButton*, void*) {
  if (m_materials!=NULL)
{
...
void MaterialsDlg::cb_btnAddMaterial(Fl_HoverButton* o, void* v) {
  ((MaterialsDlg*)(o->parent()->user_data()))->cb_btnAddMaterial_i(o,v);
}
...
void MaterialsDlg::cb_btnRemoveMaterial_i(Fl_HoverButton*, void*) {
...
void MaterialsDlg::cb_btnRemoveMaterial(Fl_HoverButton* o, void* v) {
  ((MaterialsDlg*)(o->parent()->user_data()))->cb_btnRemoveMaterial_i(o,v);
}
...
void MaterialsDlg::cb_btnEditMaterial_i(Fl_HoverButton*, void*) {
...
void MaterialsDlg::cb_btnEditMaterial(Fl_HoverButton* o, void* v) {
  ((MaterialsDlg*)(o->parent()->user_data()))->cb_btnEditMaterial_i(o,v);
}
...
void MaterialsDlg::cb_btnAssignMaterial_i(Fl_HoverButton*, void*) {
  if (this->getCurrentMaterial()!=NULL)
{
	if (m_femWidget!=NULL)
	{
...
void MaterialsDlg::cb_btnAssignMaterial(Fl_HoverButton* o, void* v) {
  ((MaterialsDlg*)(o->parent()->user_data()))->cb_btnAssignMaterial_i(o,v);
}
...
void MaterialsDlg::cb_btnClearMaterial_i(Fl_HoverButton*, void*) {
  if (m_femWidget!=NULL)
{
	FemWidget* femWidget = (FemWidget*) m_femWidget;
...
void MaterialsDlg::cb_btnClearMaterial(Fl_HoverButton* o, void* v) {
  ((MaterialsDlg*)(o->parent()->user_data()))->cb_btnClearMaterial_i(o,v);
}
...
void MaterialsDlg::show() {
  wndMaterials->show();
  this->setMaterials(m_materials);
  this->fillListBox();
}

void MaterialsDlg::setMaterials(CFemBeamMaterialSet* materials) {
...
CFemBeamMaterialSet* MaterialsDlg::getMaterials() {
  return m_materials;
}

void MaterialsDlg::hide() {
  wndMaterials->hide();
}

void MaterialsDlg::fillListBox() {
  if (m_materials!=NULL)
  {
...
CFemBeamMaterial* MaterialsDlg::getCurrentMaterial() {
  return m_currentMaterial;
}

void MaterialsDlg::setFemWidget(void* femWidget) {
