...
2. Open an example model such as a bridge, dome, building, or space frame.
3. Add a load or boundary condition.
4. Run the analysis and inspect deformation, normal force, moment, or eigenmode behavior.
5. Switch to feedback mode and move a force to build structural intuition.
...
[Browse the example gallery](examples.md)
...
[Start learning FEM with ObjectiveFrame](learning.md)
