 ...
 * @version 1.0.0
 */
class FemLSection : public FemSection {
private:
    double m_Xtp;
    double m_Ytp;
public:
    ...
    FemLSection (double height, double width, double WT, double LFT);

    /** CFemLSection destructor */
    virtual ~FemLSection ();

    FemClassInfo("FemLSection",FemSection);
