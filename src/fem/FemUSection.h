 ...
 * @version 1.0.0
 */
class FemUSection : public FemSection {
private:
    double m_Ytp;
    double m_Xtp;
public:
    ...
    FemUSection (double height, double UFW, double LFW, double WT, double UFT, double LFT);

    /** CFemUSection destructor */
    virtual ~FemUSection ();

    FemClassInfo("FemUSection",FemSection);
