...
void FemWidget::onInit()
{
    ...
    m_dlgNodeProp = new NodePropDlg();

    so_print("DialogMgr: Creating node load dialog.");
    m_dlgNodeLoads = new NodeLoadsDlg();
...
// ------------------------------------------------------------
void FemWidget::setWorkspace(double size)
{
    FltkWidget::setWorkspace(size);
#ifdef SIMPLE_GRID
...
// ------------------------------------------------------------
void FemWidget::setRepresentation(int repr)
{
...
// ------------------------------------------------------------
void FemWidget::setEditMode(int mode)
{
...
// ------------------------------------------------------------
void FemWidget::setCustomMode(int mode)
{
    if (m_customMode==OF_FEEDBACK)
    {
...
// ------------------------------------------------------------
void FemWidget::setSelectFilter(int filter)
{
    m_selectFilter = filter;
}

// ------------------------------------------------------------
void FemWidget::setDeleteFilter(int filter)
{
    m_deleteFilter = filter;
}

// ------------------------------------------------------------
void FemWidget::setHighlightFilter(int filter)
{
