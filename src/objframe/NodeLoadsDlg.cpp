...
void NodeLoadsDlg::cb_lbLoadSet_i(Fl_Browser*, void*) {
  if (m_loadSet!=NULL)
{
...
void NodeLoadsDlg::cb_lbLoadSet(Fl_Browser* o, void* v) {
  ((NodeLoadsDlg*)(o->parent()->user_data()))->cb_lbLoadSet_i(o,v);
}

void NodeLoadsDlg::cb_btnAddLoad_i(Fl_HoverButton*, void*) {
  if (m_loadSet!=NULL)
{
	char loadName[255];
	const char* result;
...
void NodeLoadsDlg::cb_btnAddLoad(Fl_HoverButton* o, void* v) {
  ((NodeLoadsDlg*)(o->parent()->user_data()))->cb_btnAddLoad_i(o,v);
}
...
void NodeLoadsDlg::cb_btnRemoveLoad_i(Fl_HoverButton*, void*) {
...
void NodeLoadsDlg::cb_btnRemoveLoad(Fl_HoverButton* o, void* v) {
  ((NodeLoadsDlg*)(o->parent()->user_data()))->cb_btnRemoveLoad_i(o,v);
}
...
void NodeLoadsDlg::cb_btnEditLoad_i(Fl_HoverButton*, void*) {
...
void NodeLoadsDlg::cb_btnEditLoad(Fl_HoverButton* o, void* v) {
  ((NodeLoadsDlg*)(o->parent()->user_data()))->cb_btnEditLoad_i(o,v);
}
...
void NodeLoadsDlg::cb_btnAssignLoad_i(Fl_HoverButton*, void*) {
  if (this->getCurrentLoad()!=NULL)
{
	if (m_femWidget!=NULL)
	{
...
void NodeLoadsDlg::cb_btnAssignLoad(Fl_HoverButton* o, void* v) {
  ((NodeLoadsDlg*)(o->parent()->user_data()))->cb_btnAssignLoad_i(o,v);
}
...
static Fl_Image *image_tlAssignNodes() {
  static Fl_Image *image = new Fl_Pixmap(idata_tlAssignNodes);
  return image;
}

void NodeLoadsDlg::cb_btnClearElements_i(Fl_HoverButton*, void*) {
  if (this->getCurrentLoad()!=NULL)
{
	if (m_femWidget!=NULL)
	{
...
void NodeLoadsDlg::cb_btnClearElements(Fl_HoverButton* o, void* v) {
  ((NodeLoadsDlg*)(o->parent()->user_data()))->cb_btnClearElements_i(o,v);
}
...
void NodeLoadsDlg::show() {
  wndNodeLoads->show();
  this->setLoadSet(m_loadSet);
  this->fillListBox();
}

void NodeLoadsDlg::setLoadSet(CFemNodeLoadSet* loadSet) {
  m_loadSet = loadSet;
  if (m_loadSet==NULL)
  {
  	lbLoadSet->clear();
...
CFemNodeLoadSet* NodeLoadsDlg::getLoadSet() {
  return m_loadSet;
}

void NodeLoadsDlg::hide() {
  wndNodeLoads->hide();
}

void NodeLoadsDlg::fillListBox() {
  if (m_loadSet!=NULL)
  {
  	std::string loadName;
  	lbLoadSet->clear();
...
CFemBeamNodeLoad* NodeLoadsDlg::getCurrentLoad() {
  return m_currentLoad;
}

void NodeLoadsDlg::setFemWidget(void* femWidget) {
