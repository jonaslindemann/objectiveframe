...
void NodeBCsDlg::cb_lbBCSet_i(Fl_Browser*, void*) {
  if (m_bcSet!=NULL)
{
	if (lbBCSet->value()>0)
	{
...
void NodeBCsDlg::cb_lbBCSet(Fl_Browser* o, void* v) {
  ((NodeBCsDlg*)(o->parent()->user_data()))->cb_lbBCSet_i(o,v);
}

void NodeBCsDlg::cb_btnAddBC_i(Fl_HoverButton*, void*) {
  if (m_bcSet!=NULL)
{
	char loadName[255];
	const char* result;
...
void NodeBCsDlg::cb_btnAddBC(Fl_HoverButton* o, void* v) {
  ((NodeBCsDlg*)(o->parent()->user_data()))->cb_btnAddBC_i(o,v);
}
...
void NodeBCsDlg::cb_btnRemoveBC_i(Fl_HoverButton*, void*) {
  if (m_currentBC!=NULL)
{
	if (m_femWidget!=NULL)
	{
...
void NodeBCsDlg::cb_btnRemoveBC(Fl_HoverButton* o, void* v) {
  ((NodeBCsDlg*)(o->parent()->user_data()))->cb_btnRemoveBC_i(o,v);
}
...
void NodeBCsDlg::cb_btnEditBC_i(Fl_HoverButton*, void*) {
...
void NodeBCsDlg::cb_btnEditBC(Fl_HoverButton* o, void* v) {
  ((NodeBCsDlg*)(o->parent()->user_data()))->cb_btnEditBC_i(o,v);
}
...
void NodeBCsDlg::cb_btnAssignBC_i(Fl_HoverButton*, void*) {
  if (this->getCurrentBC()!=NULL)
{
	if (m_femWidget!=NULL)
	{
...
void NodeBCsDlg::cb_btnAssignBC(Fl_HoverButton* o, void* v) {
  ((NodeBCsDlg*)(o->parent()->user_data()))->cb_btnAssignBC_i(o,v);
}
...
void NodeBCsDlg::cb_btnClearElements_i(Fl_HoverButton*, void*) {
  if (this->getCurrentBC()!=NULL)
{
	if (m_femWidget!=NULL)
	{
...
void NodeBCsDlg::cb_btnClearElements(Fl_HoverButton* o, void* v) {
  ((NodeBCsDlg*)(o->parent()->user_data()))->cb_btnClearElements_i(o,v);
}
...
void NodeBCsDlg::show() {
  wndNodeBCs->show();
  this->setBCSet(m_bcSet);
  this->fillListBox();
}

void NodeBCsDlg::setBCSet(CFemNodeBCSet* bcSet) {
  m_bcSet = bcSet;
  if (m_bcSet==NULL)
  {
  	lbBCSet->clear();
...
CFemNodeBCSet* NodeBCsDlg::getBCSet() {
  return m_bcSet;
}

void NodeBCsDlg::hide() {
  wndNodeBCs->hide();
}

void NodeBCsDlg::fillListBox() {
  if (m_bcSet!=NULL)
  {
  	std::string bcName;
  	lbBCSet->clear();
...
CFemBeamNodeBC* NodeBCsDlg::getCurrentBC() {
  return m_currentBC;
}

void NodeBCsDlg::setFemWidget(void* femWidget) {
