...
std::string StructureGenerator::generateStructure(const std::string& prompt) {
    ...
    fullPrompt << "\n\nThe code should define an optimized 3D beam/bar structure with minimal redundant elements. Return only the ChaiScript code needed to create this structure.";
