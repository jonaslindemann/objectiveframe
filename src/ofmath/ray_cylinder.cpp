                                          ...
                                          glm::vec3 &normal)
{
    ...
    float c = glm::dot(f, f) - glm::dot(f, cylinder_axis_normalized) * glm::dot(f, cylinder_axis_normalized) -
              radius * radius;
...
bool intersectRayOrientedCylinder(const Ray &ray, float radius, float height, Vector3 cylinder_position,
                                  Vector3 cylinder_axis, Vector3 &pos, Vector3 &normal)
{
