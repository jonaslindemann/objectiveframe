...
{
    if ((idx >= 0) && (idx < 256)) {
        material->setDiffuseColor(m_colorTable[idx][0], m_colorTable[idx][1], m_colorTable[idx][2], 1.0f);
        material->setAmbientColor(m_colorTable[idx][0] * 0.25f, m_colorTable[idx][1] * 0.25f,
