...
void CElementLoadsDlg::cb_lbLoadSet_i(Fl_Browser*, void*) {
    if (m_loadSet!=NULL)
    {
...
void CElementLoadsDlg::cb_lbLoadSet(Fl_Browser* o, void* v) {
    ((CElementLoadsDlg*)(o->parent()->user_data()))->cb_lbLoadSet_i(o,v);
}

void CElementLoadsDlg::cb_btnAddLoad_i(Fl_HoverButton*, void*) {
    if (m_loadSet!=NULL)
    {
        std::string loadName;
...
void CElementLoadsDlg::cb_btnAddLoad(Fl_HoverButton* o, void* v) {
    ((CElementLoadsDlg*)(o->parent()->user_data()))->cb_btnAddLoad_i(o,v);
}
...
void CElementLoadsDlg::cb_btnRemoveLoad_i(Fl_HoverButton*, void*) {
...
void CElementLoadsDlg::cb_btnRemoveLoad(Fl_HoverButton* o, void* v) {
    ((CElementLoadsDlg*)(o->parent()->user_data()))->cb_btnRemoveLoad_i(o,v);
}
...
void CElementLoadsDlg::cb_btnEditLoad_i(Fl_HoverButton*, void*) {
...
void CElementLoadsDlg::cb_btnEditLoad(Fl_HoverButton* o, void* v) {
    ((CElementLoadsDlg*)(o->parent()->user_data()))->cb_btnEditLoad_i(o,v);
}
...
void CElementLoadsDlg::cb_btnAssignLoad_i(Fl_HoverButton*, void*) {
    if (this->getCurrentLoad()!=NULL)
    {
        if (m_femWidget!=NULL)
        {
...
void CElementLoadsDlg::cb_btnAssignLoad(Fl_HoverButton* o, void* v) {
    ((CElementLoadsDlg*)(o->parent()->user_data()))->cb_btnAssignLoad_i(o,v);
}
...
static Fl_Pixmap image_tlAssignNodeLoad(idata_tlAssignNodeLoad);

void CElementLoadsDlg::cb_btnClearElements_i(Fl_HoverButton*, void*) {
    if (this->getCurrentLoad()!=NULL)
    {
        if (m_femWidget!=NULL)
        {
...
void CElementLoadsDlg::cb_btnClearElements(Fl_HoverButton* o, void* v) {
    ((CElementLoadsDlg*)(o->parent()->user_data()))->cb_btnClearElements_i(o,v);
}
...
CElementLoadsDlg::CElementLoadsDlg() {
...
void CElementLoadsDlg::show() {
    wndElementLoads->show();
    this->setLoadSet(m_loadSet);
    this->fillListBox();
}

void CElementLoadsDlg::setLoadSet(CFemElementLoadSet* loadSet) {
    m_loadSet = loadSet;
    if (m_loadSet==NULL)
    {
        lbLoadSet->clear();
...
CFemElementLoadSet* CElementLoadsDlg::getLoadSet() {
    return m_loadSet;
}

void CElementLoadsDlg::hide() {
    wndElementLoads->hide();
}

void CElementLoadsDlg::fillListBox() {
    if (m_loadSet!=NULL)
    {
        std::string loadName;
        lbLoadSet->clear();
...
CFemBeamLoad* CElementLoadsDlg::getCurrentLoad() {
    return m_currentLoad;
}

void CElementLoadsDlg::setFemWidget(void* femWidget) {
