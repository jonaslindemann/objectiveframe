...
static Fl_Pixmap image_tlInspMaterial(idata_tlInspMaterial);
...
static Fl_Pixmap image_tlAssignMaterial(idata_tlAssignMaterial);
...
static Fl_Pixmap image_tlClearMaterial(idata_tlClearMaterial);
